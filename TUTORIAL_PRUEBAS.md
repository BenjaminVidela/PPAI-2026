...
Abrir **otra** terminal en `frontend` y ejecutar:

Primero (solo la primera vez):
```
npm install
```
...
|--------------|---------|----|-----|
| `http://localhost:8080/api/demo/login/jperez` | Juan Pérez | Buenos Aires | Empleado — 3 bolsines |
| `http://localhost:8080/api/demo/login/mlopez` | María López | Buenos Aires | GCM — 3 bolsines |
| `http://localhost:8080/api/demo/login/rfernandez` | Roberto Fernández | Córdoba | GCM — 1 bolsín |
