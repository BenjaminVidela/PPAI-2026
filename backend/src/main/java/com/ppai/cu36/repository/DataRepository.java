...
public class DataRepository {
    ...
    static {
        ...
        CambioEstadoBolsin ce1 = new CambioEstadoBolsin(LocalDateTime.now().minusHours(5), "Sistema", estadoEnviado);
        Bolsin b1 = new Bolsin(LocalDate.now(), 1001, 55001, 320.5, cmBuenosAires, cmCordoba, Arrays.asList(ce1));

        CambioEstadoBolsin ce2 = new CambioEstadoBolsin(LocalDateTime.now().minusHours(3), "Sistema", estadoEnviado);
        Bolsin b2 = new Bolsin(LocalDate.now(), 1002, 55002, 415.0, cmBuenosAires, cmRosario, Arrays.asList(ce2));

        CambioEstadoBolsin ce3 = new CambioEstadoBolsin(LocalDateTime.now().minusHours(8), "Sistema", estadoEnviado);
        Bolsin b3 = new Bolsin(LocalDate.now().minusDays(1), 1003, 55003, 180.0, cmBuenosAires, cmMendoza, Arrays.asList(ce3));

        CambioEstadoBolsin ce4 = new CambioEstadoBolsin(LocalDateTime.now().minusHours(2), "Sistema", estadoEnviado);
